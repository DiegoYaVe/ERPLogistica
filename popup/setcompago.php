...
<div class="container-fluid mt-1 rounded">
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="form-grop">
        <input type="text" name="nmb" class="form-control" id="nmb" autocomplete="off" placeholder="Escribe nombre, apellido o Nombre corto del cliente buscado" autofocus />
    </div>
  </div>
</div>
...
?>
    ...
    <script type="text/javascript" src="js/busqueda_clientecomp.js"></script>
  </div>
  </body>
  <!-- ////////////////////////////////////////////////////////////////////////////-->
</html>