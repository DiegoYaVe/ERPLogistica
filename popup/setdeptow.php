...
session_start();
  ...
  $depto->selectdep($_GET['id']);
  if($depto->id){
    $accion = 'updatedepto&id='.$_GET['id'];
    $title = "Registrar un ";
  }
  else{
    $accion = 'insertdepto';
...
<div class="container mt-1 ">
  <form action="?modulo=departamentosw&accion='.$accion.'" method="post" onsubmit="checksubmit();">
    ...
    <div class="row">
      <div class="col-12 col-md-12 alert alert-primary">'.$title.' Departamentos</div>
  ...
  echo '
    <div class="row">
      <div class="col-12 col-md-12 ">
        <div class="mb-5">
          <label for"nmbac">Nombre del Departamento</label>
