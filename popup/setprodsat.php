...
<div class="container mt-1 rounded">
  <h3 class="mb-5">Producto/Servicio SAT</h3>
  <div class="row">
    <div class="col-md-12">
      <div class="form-grop">
        <input type="text" name="nmb" class="form-control" id="nmb" autocomplete="off" placeholder="Nombre o clave SAT buscada" autofocus />
    </div>
  </div>
</div>
...
//  var marca = $("#ch"+condicion).prop('checked');
  var descripcion = condicion;
  window.opener.cliedit.clavesat.value =  descripcion;
  window.close();
}
</script>
    <!-- BEGIN VENDOR JS-->
    ...
    <script type="text/javascript" src="js/busqueda_prodsat.js"></script>
  </div>
  </body>
  <!-- ////////////////////////////////////////////////////////////////////////////-->
</html>