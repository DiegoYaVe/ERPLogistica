...
<div class="container mt-1 rounded">
  <h4 class="mb-5">Clave SAT</h4>
  <div class="row">
    <input type="hidden" id="empresa" value="'.$_SESSION['emp'].'" />
    <div class="col-md-12">
      <div class="form-grop">
        <input type="text" name="nmb" class="form-control" id="nmb" autocomplete="off" placeholder="¿Qué unidad de medida estas buscando?" autofocus />
    </div>
  </div>
</div>
...
?>
    ...
    <script type="text/javascript" src="js/busqueda_unidades.js"></script>
  </div>
  </body>
  <!-- ////////////////////////////////////////////////////////////////////////////-->
</html>