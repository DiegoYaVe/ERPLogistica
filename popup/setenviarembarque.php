    ...
    <div class="col-12 alert alert-primary">Nuevo embarque de artículos</div>
      ...
      <div class="mb-5 col-md-4">
        ...
        <label>Fecha de envío:</label>
          <input class="form-control" type="date" name="fechaenvio" id="fechaenvio" value="'.$fechaenvio.'" min="'.$fechaenvio.'" required>
        </div> 
      <div class="mb-5 col-md-6">
        ...
        <label>Paqueteria:</label>
          <select class="form-control" name="paqueteria" id="paqueteria" required>';
            ...
            echo '<option value="0">OCURRE</option>
                  <option value="-1">RECOGE CLIENTE</option>';
          echo '</select>
        </div>
