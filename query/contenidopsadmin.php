      ...
      <div class="card card-xl-stretch mb-xl-8">
        ...
        ';
          ...
          while($row = $result -> fetch_array()){
            ...
            $html.='<div class="progress-bar bg-'. $colores[$i] .'" role="progressbar" style="width: '. $porgrupo.'%; heigth:20px" aria-valuenow="'. $porgrupo.'" 
              aria-valuemin="0" aria-valuemax="100"  data-bs-toggle="tooltip" data-bs-html="true" data-bs-placement="'. $pos.'" title="<b>Asesor:</b> '. $row['u_nmb'].' '.$row['u_apellidos'] .' <br> 
               <b>Vendido: </b> $'.  number_format($totacumu, 2).' <br>  <b> % de la meta:</b> '.  number_format($porgrupo, 2).'%">
               '. number_format($porgrupo, 2).'%
            </div>
            ';
            $i++;
            $j++;
    ...
    <div class="card-body my-3">
      <div class="py-1">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <span class="card-title fw-bolder text-success fs-1 mb-3">$ '. number_format($metagrupo, 2) .'</span>
        </div>
      </div>
      <div class="py-1">
        <span class="text-dark fs-1 fw-bolder me-2">$ '. number_format($totacum, 2) .'</span>
        <span class="fw-bold text-muted fs-7">Ventas del mes</span>
      </div>
      <div class="progress h-30px bg-success bg-opacity-50 mt-7">
        <div class="progress-bar bg-success fs-4" role="progressbar" style="width: '. number_format($porventa, 2) .'%; height" aria-valuenow="'. number_format($porventa, 2) .'" aria-valuemin="0" aria-valuemax="100">'. number_format($porventa, 2) .'% </div>
      </div>
    </div>
  </div>
  <div class="col-xl-12">
            ...
            while($row = $result -> fetch_array()){
              ...
              $html.='<div class="col-xl-4">
                ...
                <a class="card bg-'. $colores[$i] .' hoverable card-xl-stretch mb-xl-8">
                  <!--begin::Body-->
                  <div class="card-body">
                    <div class="text-white fw-bolder fs-2 mb-2 mt-5">'. $row['cat_nmb'].'</div>
                    <div class="fw-bold text-white">'. number_format($cantidad, 0).' vendidos</div>
                    <div class="fw-bold text-white">$'. number_format($precio, 2).' </div>
                  </div>
                  <!--end::Body-->
                </a>
          ...
          <div class="col-xl-4">
            ...
            <a class="card bg-'. $colores[$i] .' hoverable card-xl-stretch mb-xl-8">
              ...
              <div class="card-body">
                ...
                <div class="fw-bold text-white">'. number_format($cantidad, 0).' paquetes vendidos</div>
                <div class="fw-bold text-white">$'. number_format($precio, 2).'</div>
              </div>
              <!--end::Body-->
            </a>
    ...
    <div class="col-xl-12">
      ...
      while($row10 = $result10 -> fetch_array()){
        ...
        <div class="card-body pt-0">
          ...
          <span class="badge badge-light-'. $colores[$j].' fs-5 fw-bolder">'. $i.'</span>
            <!--begin::Checkbox-->
            ...
            <!--end::Checkbox-->
              ...
              <div class="flex-grow-1">
                <span class="text-gray-800 fw-bolder fs-6">'. $nmb.'</span>
                <span class="text-muted fw-bold d-block">'. $row10['cantidad'].' vendidos</span>
              </div>
              <!--end::Description-->
              <!--begin::Bullet-->
            <span class="bullet bullet-vertical h-40px bg-'. $colores[$j].'"></span>
            <!--end::Bullet-->
