...
var $aligns;
  ...
  function Header()
  {
    ...
    $this->SetTextColor(0, 0, 0);
      ...
      $this->Cell(40);
      $this->Cell(85,5,utf8_decode(substr($emp->nmb,0,40)),0,0,"C");

      $this->Ln();
      $this->Cell(40);
      $this->SetTextColor(0, 0, 0);
      $this->Cell(85,5,utf8_decode(substr($emp->razons,0,40)),0,0,"C");
      

      $this->Ln();
      $this->SetTextColor(0, 0, 0);
      $this->Cell(40);
      $this->Cell(85,5,"R.F.C. ".$emp->rfc,0,0,"C");
      

      $this->Ln();
      $this->Cell(40);
      $this->Cell(85,4,$emp->calle.' '.$emp->nume.' '.$emp->numi,0,0,"C");
      

      $this->Ln();
      $this->Cell(40);
      $this->Cell(85,4,utf8_decode('COL. '.$emp->colonia.' '.$emp->ciudad),0,0,"C");
      

      $this->Ln();
      $this->Cell(40);
      $this->Cell(85,4,utf8_decode(mb_strtoupper(busca($emp->estado,'estado','e_id','e_nmb'))." ".$emp->cp),0,0,"C");
      $this->Ln();
  ...
  $this->SetTextColor(0,0,0);
  //$this->Cell(51,6,utf8_decode($recep->solicita),1,0);
  ...
  //$this->Cell(40,6,utf8_decode(fecha_formato($recep->fapli,true,true)),1,0);
  $this->SetTextColor(0,0,0);
  ...
  if($recep->destino != "" || $recep->receptor != ""){
    $this->SetFont('kalingab','',12);
    $this->Cell(35);
    $this->Cell(110,10,utf8_decode('RECEPCIÓN'),0,0,"C");
    $this->Ln();
    $this->SetFont('kalinga','',9);
    ...
    $this->SetFillColor(91, 155, 213);
    $this->SetTextColor(255,255,255);
    $this->Cell(41,6,utf8_decode("Domicilio entrega:"),1,0,'C',true);
    $this->SetTextColor(0,0,0);
    $this->Cell(143,6,utf8_decode($recep->destino),1,0);
    $this->Ln();

    $this->Cell(4);
    $this->SetFillColor(91, 155, 213);
    $this->SetTextColor(255,255,255);
    $this->Cell(41,6,utf8_decode("Receptor:"),1,0,'C',true);
    $this->SetTextColor(0,0,0);
    $this->Cell(143,6,utf8_decode($recep->receptor),1,0);
    $this->Ln();
  }
  ...
  $this->SetFillColor(91, 155, 213);
  $this->SetTextColor(255,255,255);
  $this->Cell(41,6,utf8_decode("Dirección:"),1,0,'C',true);
  $this->SetTextColor(0,0,0);
  $this->Cell(51,6,utf8_decode($recep->folio),1,0);
  $this->Ln(); */
...
//###definir el ancho de columna
  $col1=17; $col2=22; $col3=100; $col4=22; $col5=25;
...
while($row=$resultado->fetch_array()){
  ...
  $precioProducto=$row['od_cantidad']*$row['od_precio'];
    ...
    $pdf->RowMin(array($row['od_cantidad'],utf8_decode($row['od_nparte']),utf8_decode($row['od_nmbarticulo']),'$'.number_format($row['od_precio'],2),'$'.number_format($precioProducto,2)),false);
    $bandera=!$bandera;
}
