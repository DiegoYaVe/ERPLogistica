...
$sql = 'SELECT lm_nmb,COUNT(*),la_paquete FROM licencias_adicionales INNER JOIN licencias_modalidades ON la_paquete = lm_producto WHERE la_estatus NOT IN ("N","P","R") ';
if($fini || $ffin ){
  $sql .= ' AND DATE(la_fini) BETWEEN "'.$fini.'" AND "'.$ffin.'" ';
}
$sql .= ' GROUP BY la_paquete ';
...
header('Content-Disposition: attachment;filename="Ventas Extra.xlsx"');
